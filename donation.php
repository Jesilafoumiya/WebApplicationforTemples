              ...
              <div class="sigma_product-single-content">
                ...
                <form class="sigma_product-atc-form">
                  ...
                  <div class="qty-outter">
                    <a href="product-single" class="sigma_btn-custom secondary">Buy Now</a>
                    <div class="qty-inner">
                      <h6>Qty:</h6>
                      <div class="qty">
  ...
  <div class="section">
    <div class="container">
      <div class="section-title text-center">
       <h4 class="title">ANNADHANAM DONATION</h4>
      </div>
      <div class="row">
        <div class="col-lg-5">
          <div class="sigma_member-image style-1 mt-1">
            <img src="assets/img/ayyapan/8.jpg" class="mb-0" alt="volunteer">
          </div>
        </div>
        <div class="col-lg-7">
          <div class="sigma_volunteer-detail-inner mt-5 mt-lg-0 ps-0 ps-lg-4">
            <h6 class="sigma_member-name">Kindly find the below account number and give your contribution as your wish</h6>
            <span class="sigma_volunteer-detail-category"></span>
            <ul class="sigma_volunteer-detail-info" style="font-size: 20px;">
              <li>
                <span class="title" style="font-weight: bold; padding-right: 10px;">A/C NAME: </span> AYYAPPA SEVA SANGAM
              </li>
              <li>
                <!-- <i class="fas fa-envelope"></i> -->
                <span class="title" style="font-weight: bold; padding-right: 10px;">A/C NO : </span>10072248615
              </li>
              <li>
                <!-- <i class="fas fa-map-marker-alt"></i> -->
                <span class="title" style="font-weight: bold; padding-right: 10px;">BANK : </span>STATE BANK OF INDIA
              </li>
              <li>
                <!-- <i class="fas fa-map-marker-alt"></i> -->
                <span class="title" style="font-weight: bold; padding-right: 10px;">BRANCH: </span>KAMARAJAPURAM NEW BHEL TOWNSHIP,
              </li>
              <li>
                <!-- <i class="fas fa-map-marker-alt"></i> -->
                <span class="title" style="font-weight: bold; padding-right: 10px;">IFS CODE: </span>SBIN0006845
              </li>
            </ul>
